...
--1# Display only car's brands and  car's models and car's price
...
--9 Display cars where car's models starts with 'T'
...
--13 Display the most expensive car and the cheapest car
...
--17 Diplay cars where car's year os issue not between 1995 and 2005
